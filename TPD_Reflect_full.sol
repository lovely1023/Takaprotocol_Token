...
contract TDP is Context, IERC20, Ownable {
    ...
    string private _name = 'Takaprotocol Token';
    ...
    uint256 constant public TOTAL_SUPPLY = 3000000000 * 10**9 ;
    uint256 constant public TEAM_SUPPLY = 600000000 * 10**9;
    uint256 constant public TEAM_STEP_SUPPLY = 150000000 * 10**9;
    uint256 constant public INVESTOR_SUPPLY = 300000000 * 10**9;
    uint256 constant public INVESTOR_STEP_SUPPLY = 60000000 * 10**9;
    uint256 constant public SALE_SUPPLY = 2100000000 * 10**9;

    address public TEAM_ADDRESS = 0xBc608B6fE8F0E8bcb68724f479AbF29cda2e2134; //TEST ADDRESS
    address public INVESTOR_ADDRESS = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2; //TEST ADDRESS

    uint256 public datetime = 1 days;
    ...
    constructor () public {
        ...
        _tOwned[msg.sender] = TOTAL_SUPPLY;
        _transfer(msg.sender, TEAM_ADDRESS, TEAM_STEP_SUPPLY);
        _tOwned[TEAM_ADDRESS] = TEAM_STEP_SUPPLY;
        _tOwned[msg.sender] = _tOwned[msg.sender].sub(TEAM_STEP_SUPPLY);
